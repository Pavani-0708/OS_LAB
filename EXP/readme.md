...
![date date command output](dateD.png)
### DATE TIME COMMAND OUTPUT
![date time command output](dateT.png)
### DATE YEAR COMMAND OUTPUT
![date year command output](dateY.png)
...
###CMD NAME
![man cmd name command output](mancmdname.png)
## IP FILE COMMANDS
...
### MKDIR COMMAND OUTPUT
![mkdir command output](mkdir1.png)
...
![cat filename command output](cat1.png)
### CAT >> FILENAME COMMAND OUTPUT
